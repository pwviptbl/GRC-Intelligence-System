...
<body>
    <div class="no-print" style="position: fixed; top: 20px; right: 20px; display:flex; align-items:center; gap:10px;">
        ...
        <a href="{{ route('treinamentos.export.zip') }}" style="background:#059669; color:white; text-decoration:none; padding:10px 18px; border-radius:6px; font-weight:bold; font-size:13px; display:inline-flex; align-items:center; gap:6px;">📦 Baixar Pacote ZIP (Separados)</a>
